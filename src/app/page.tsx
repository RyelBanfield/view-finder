...
const Home = async () => {
  ...
  return (
    <>
      ...
      <section id="about-us" className="space-y-4 px-6 pb-24 pt-12 md:pt-24">
        <h2 className="text-balance text-center text-2xl font-bold md:text-3xl">
          We&apos;re focused on experience.
        </h2>

        <p className="mx-auto max-w-3xl text-balance text-center text-sm text-muted-foreground md:text-base">
